 ...
 */
//Apollo
class ApolloPanel extends JPanel {
...
class DIYPanel extends JPanel {
	...
	// for DIY
		//radioButton
		protected JRadioButton diyMandRb = new JRadioButton(s.MANDELBROT,true);
		protected JRadioButton diyJuliaRb = new JRadioButton(s.JULIA);
		protected JRadioButton diyApolloRb = new JRadioButton(s.APOLLONIAN_CIRCLES);
		
		protected ButtonGroup diyBg = new ButtonGroup();
		
		// diy fractal art option choice
		private String diyMand = "DIY_"+s.MANDELBROT;
		private String diyJulia = "DIY_"+s.JULIA;
		private String diyApollo = "DIY_"+s.APOLLONIAN_CIRCLES;
...
class SierpinskiComboPanel_vInternalFrameTesting extends JPanel {
	...
	////////////////////////////////////////////////////////////
	// Fractal Art Choices
	static final String SIERPINSKI_SQUARES = "SierpinskiSquares";
	static final String APOLLONIAN_CIRCLES = "ApollonianCircles";
	static final String SIERPINSKI_TRIANGLES = "SierpinskiTriangles";
	static final String CST_FRACTAL = "CSTFractal";
	static final String SAMPLE = "Sample";
	static final String MANDELBROT = "Mandelbrot";
	static final String JULIA = "Julia";
	static final String FANNY_TRIANGLES = "FannyTriangles";
	static final String FANNY_CIRCLE = "FannyCircle";
	static final String KOCHSNOWFLAKE = "KochSnowFlake";
	static final String DIY	="Do_It_Yourself";
	...
	private SierpinskiCompositional_vInternalFrameTesting s;
...
//System.out.println("Here---doSetDiyFractalChoice -- "+diyChoice);
	...
	private void doStartCommand() {
		...
		/*final*/ /*FractalBase */this.ff = null;;
...
//			this.doReset();
	...
	private void startFractals(final FractalBase ff) {
		System.out.println("In__StartFractals____ff=nul==="+(ff==null));
		SierpinskiCompositional_vInternalFrameTesting.getOutFrame().setVisible(true);
		
		
		SierpinskiCompositional_vInternalFrameTesting.setFf(ff);
		
		final FractalBase frame = SierpinskiCompositional_vInternalFrameTesting.ff;
		
		System.out.println("s.getOutFrame()NULL====="+(SierpinskiCompositional_vInternalFrameTesting.getOutFrame()==null));
		System.out.println("SierpinskiCompositional.getFf()====="+(SierpinskiCompositional_vInternalFrameTesting.getFf()==null));
		SierpinskiCompositional_vInternalFrameTesting.getOutFrame().add(SierpinskiCompositional_vInternalFrameTesting.getFf());
...
public class SierpinskiCompositional_vInternalFrameTesting extends JFrame {

	private static final long serialVersionUID = 17584L;
	private static SierpinskiComboPanel topPanel = new SierpinskiComboPanel();
	private static JInternalFrame outFrame = new JInternalFrame(); 
	
	static FractalBase ff;

	/**
	 * @throws HeadlessException
	 */
	public SierpinskiCompositional_vInternalFrameTesting() throws HeadlessException {
		super();
		this.initComponents();
	}
	...
	private void initComponents() {
		...
		cp.add(topPanel);
//		cp.add(this.outFrame);
		
		topPanel.setVisible(true);
		outFrame.setBorder(new BevelBorder(0, Color.RED,Color.BLUE));
//		this.outFrame.setVisible(false);
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
		      @Override
		      public void run() {
		        final SierpinskiCompositional_vInternalFrameTesting frame = new SierpinskiCompositional_vInternalFrameTesting();
	...
	public static FractalBase getFf() {
		return ff;
	}

	public static void setFf(FractalBase fr) {
		ff = fr;
	}

	public static SierpinskiComboPanel getTopPanel() {
		return topPanel;
	}

	public static void setTopPanel(SierpinskiComboPanel tPanel) {
		topPanel = tPanel;
	}

	public static JInternalFrame getOutFrame() {
		return outFrame;
	}

	public static void setOutFrame(JInternalFrame outFr) {
		outFrame = outFr;
	}
