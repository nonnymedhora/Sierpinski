...
public class SierpinskiTriangle__v0 extends JFrame implements Runnable {
...
*/		
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				final SierpinskiTriangle__v0 frame = new SierpinskiTriangle__v0();
